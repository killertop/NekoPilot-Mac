...
// Action hues and fills both reference theme tokens so dark mode keeps the
// same hierarchy without freezing light-mode alpha values.
...
export const ACTION_TINT: Record<RuleAction, string> = {
  direct: "var(--onebox-green-fill)",
  proxy: "var(--onebox-blue-fill)",
};
...
export const KIND_META: Record<
  RuleKind,
  { glyph: string; abbr: string; placeholder: string }
> = {
