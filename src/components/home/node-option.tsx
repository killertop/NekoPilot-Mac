...
const STYLES = {
  ...
  protocolContainer:
    "grid grid-cols-[minmax(0,1fr)_auto_minmax(3.5rem,auto)] items-center gap-2 w-full",
  ...
  startingContainer: "text-sm font-medium",
} as const;
...
const DelayIndicator = (
  { delay, hasDelay, isTesting }: DelayIndicatorProps,
) => {
...
export default function NodeOption({
  ...
  if (!nodeName) {
    return (
      <div
        className={STYLES.startingContainer}
